    ...
    try:
        ...
        if channel_summaries:
            ...
            blocks = [
                {
                    "type": "header",
                    "text": {"type": "plain_text", "text": "📊 Daily Master Report"},
                },
                {"type": "section", "text": {"type": "mrkdwn", "text": master_report}},
                {"type": "divider"},
                {
                    "type": "section",
                    "text": {"type": "mrkdwn", "text": "*Team Summaries:*"},
                },
            ]
            ...
            response = app.client.chat_postMessage(
                channel=master_channel, text="📊 Daily Master Report", blocks=blocks
            )
